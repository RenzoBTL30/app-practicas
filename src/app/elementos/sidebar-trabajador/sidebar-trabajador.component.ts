...
export const ROUTES1: RouteInfo[] = [
  ...
  {
    path: '/secretaria/pages/validar-solicitud',
    title: 'Validar Solicitudes',
    icon: 'verified',
    class: '',
  },
  {
    path: '/secretaria/pages/agregar-carta',
    title: 'Agregar Carta presentación',
    icon: 'add_circle_outline',
    class: '',
  },
  {
    path: '/secretaria/pages/gestionar-postulantes',
    title: 'Gestionar Postulantes',
...
export const ROUTES2: RouteInfo[] = [
  {
    path: '/supervisor/pages/validar-plaza',
    title: 'Validar plazas',
    icon: 'verified',
    class: '',
  },
  {
    path: '/supervisor/pages/validar-practicas',
    title: 'Validar prácticas',
    icon: 'add_circle_outline',
    class: '',
  },
  { path: '', title: 'SALIR', icon: '', class: 'active-pro' },
...
export const ROUTES3: RouteInfo[] = [
  ...
  {
    path: '/admin/pages/gestionar-supervisores',
